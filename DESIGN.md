...
（空态）、`docs/design/legend-notes.png`（状态图例与标注）。本文件和导出图都是设计缓存；最新在线 Figma 为权威。2026-09-12 复核节点为 `40:41`、`40:81`、`77:10`；审计和验收见 `docs/figma-ui-audit-2026-09-12.md`。
...
- 底部 App 启动器：具体视觉见 `docs/design-launcher-proposal.md`。2026-09-12 用户修订：绿点表示尚未查看的完成会话，点图标/绿点依列表顺序跳转一条并收起；CLI 按 tty 返回终端，App 沿用已有导航。全部点完绿点才消失；没有完成项时正常打开 App。
